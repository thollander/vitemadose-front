              ...
              <div class="rdvForm-fields row align-items-center mb-3 mb-md-5">
                ...
                <div class="px-0 col">
                  <vmd-input-range-with-tooltip
                      ...
                      .options="${[
                          {code: "1km", libelle:"<1km"}, {code: "2km", libelle:"<2km"}, {code: "5km", libelle:"<5km"},
                          {code: "10km", libelle:"<10km"}, {code: "20km", libelle:"<20km"}, {code: "50km", libelle:"<50km"},
                          {code: "100km", libelle:"<100km"}, {code: "150km", libelle:"<150km"}
                      ]}"
                      @option-selected="${(e: CustomEvent<{value: string|undefined}>) => console.log(`Option sélectionnée : ${e.detail.value}`)}"
                  ></vmd-input-range-with-tooltip>
                </div>
              </div>
              <div class="rdvForm-fields row align-items-center mb-3 mb-md-5">
